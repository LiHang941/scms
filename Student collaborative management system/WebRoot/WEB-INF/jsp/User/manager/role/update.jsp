...
<body>
	...
	<div class="place">
		<span>位置：</span>
		<ul class="placeul">
			<li><a href="${pageScope.basePath}manager/index"
				target="rightFrame">首页</a></li>
			<li><a href="${pageScope.basePath}manager/user/role/list"
		...
		<div id="usual1" class="usual">
			...
			<div id="tab1" class="tabson">
				...
				<ul class="forminfo">
					...
					<input id="roleName" name="role.name"
						type="text" class="dfinput" style="width:350px;" value="<s:property value="role.name"/>"/></li>
					...
					<li>
						<div
							style="width:400px;height:auto;border:1px solid #cccccc;padding: 20px;">
							<table style="">
								<tr>
									...
									<td style="padding:10px;"><s:property
										...
										value="<s:property value="#modularModel.getId()"/>" 
										<s:iterator value="role.authoritys" id="authority" status="authoritySet">
												<s:if test="#authority.modular.id == #modularModel.getId()">
													checked="checked"
												</s:if>  
										</s:iterator>  
										/></td>
