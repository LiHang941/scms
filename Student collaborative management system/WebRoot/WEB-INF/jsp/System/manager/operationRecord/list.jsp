...
var _basePath = "${pageScope.basePath}";
  ...
  $(".sure").click(function(){
 		...
 		$tbodyInputs.each(function(){
   			 if(this.checked){
   			 	...
   			 	var _id = $(this).val();
   			 	var _url =_basePath +"manager/system/operationRecord/delete.do?operationRecord.id="+_id;
  ...
  $(".cancel").click(function(){
	...
	function goByPage(_PageIndex){
		...
		var _url = _basePath + "manager/system/operationRecord/list.do?page.p="+_PageIndex;
		if(_SearchStr != ""){
	...
	<div class="rightinfo">
		...
		<div class="tools">
			...
			<ul class="toolbar1">
				...
				<li><a href="${pageScope.basePath}manager/system/operationRecord/list.do?searchStr="><span><img
		...
		<table class="tablelist">
			<thead>
				<tr>
					...
					<th style="width:60%;">记录</th>
					<th style="width:5%;">操作</th>
				</tr>
			</thead>
			<tbody>
				<s:iterator value="operationRecordList" id="operationRecordModel" status="list">
					<tr>
						<td><input name="" type="checkbox"
							value="<s:property value="#operationRecordModel.id"/>" /></td>
						<td><s:property value="#operationRecordModel.user.account" /></td>
						<td><s:date name="#operationRecordModel.date" format="yyyy-MM-dd HH:mm:ss"/></td>
						<td><s:property value="#operationRecordModel.record" /></td>
						<td><a
							href="${pageScope.basePath}manager/system/operationRecord/delete.do?operationRecord.id=<s:property value="#operationRecordModel.id"/>"
