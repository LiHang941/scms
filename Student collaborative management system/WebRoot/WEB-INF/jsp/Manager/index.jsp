...
<%@ include file="/Backstage/common/backstage.jsp" %>
	...
	var _user_LatelyDate_url = _basePath + "manager/currency/myAccessLog/userAccessLately.do";
	$(document).ready(function() {
		//加载最近访问信息
		$.get(_user_LatelyDate_url, null,
				function(data){
					$("#LatelyDate").text("您上次登录的时间：" + data.date);
			 },'json');
...
<body>
    ...
    <i id="LatelyDate">您上次登录的时间：加载中</i> （不是您登录的？<a href="${pageScope.basePath}manager/currency/myAccessLog/myAccessListUI.do">请点这里</a>）
    </div>
